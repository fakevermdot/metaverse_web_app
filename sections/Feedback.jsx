...
const Feedback = () => (
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      <motion.div variants={fadeIn('right', 'tween', 0.2, 1)} className="flex-[0.5] lg:max-w-[370px] flex justify-end flex-col gradient-05 sm:p-8 p-4 rounded-[32px] border-[1px] border-[#6a6a6a] relative ml-10 ">
      ...
      <motion.div variants={fadeIn('left', 'tween', 0.2, 1)} className="relative flex flex-1 justify-center items-center mr-8">
